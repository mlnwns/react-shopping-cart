...
const Leading = css`
  cursor: pointer;
`;
const Text = ({ text, type = "small", testId }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: TextStyle(type), "data-testid": testId, children: text });
};
...
const ConfirmButton = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      onClick,
      disabled,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { text, type: "medium" })
    }
  );
};
...
const TextButtonStyle = css`
  ...
  border-radius: 4px;
`;
const StepperButton = ({ testId, type, onClick }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      "data-testid": testId,
      ...
      children: type === "decrease" ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "./decrease.svg" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "./increase.svg" })
    }
  );
};
...
const QuantityStepper = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: QuantityStepperStyle, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { text: quantity.toString() }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      StepperButton,
      {
...
const API_TOKEN = "bWxud25zOnBhc3N3b3Jk";
async function apiClient({
  ...
  try {
    ...
    const response = await fetch(url, {
      method,
      headers: {
        ...["POST", "PATCH", "PUT"].includes(method) ? { "Content-Type": "application/json" } : {},
...
const cartItemsApi = {
  ...
  patch: async (cartItemId, quantity) => {
    try {
      const response = await apiClient({
...
const CartItemCard = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: CartItemStyled, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: CartItemContent, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: CartItemDetails, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { text: name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { text: price.toLocaleString() + "원", type: "large" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: QuantityStepperWrapper, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          QuantityStepper,
          {
            quantity,
            onDecrease: () => {
...
const PriceRow = ({ title, price, testId }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: PriceRowStyle, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { text: price.toLocaleString() + "원", type: "large", testId })
  ] });
};
const PriceRowStyle = css`
  ...
  margin: 12px 0;
`;
const OrbitSpinner = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: spinnerContainerStyle, "data-testid": "loading-spinner", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: orbitSpinnerStyle, "data-testid": "progress-indicator", children: [
...
`;
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: AppStyles, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartItemPage, {})
  ] });
}
const AppStyles = css`
  min-height: 100dvh;
